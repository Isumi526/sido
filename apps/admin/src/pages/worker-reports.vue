  ...
  <div>
    ...
    <div class="page-header">
      ...
      <div class="header-right">
        ...
        <button v-if="canViewWages" class="btn-toggle-cost" :class="{ active: showLaborCost }" @click="showLaborCost = !showLaborCost">
    ...
    <template v-else>
      ...
      <template v-if="activeWorker && workerMap[activeWorker]">
        ...
        <div class="summary-grid">
          ...
          <!-- 人件費カード -->
          <div v-if="canViewWages && showLaborCost" class="summary-card cost-card">
        ...
        <!-- 人件費内訳 -->
        <template v-if="canViewWages && showLaborCost && laborCostBreakdown.length">
