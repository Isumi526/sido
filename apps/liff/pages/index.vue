...
const { bySection: navBySection } = useNavItems(() => authMode.value, () => canApplyPersonalExpense.value, () => isLiffFeatureEnabled('inventory'))
const NAV_ICON_COLORS: Record<string, string> = {
  ...
  '/sites': '#22c55e', '/inventory': '#0891b2', '/expense/download': '#ef4444', '/expense/personal': '#d946ef', '/rules': '#0d9488', '/password': '#64748b',
}
