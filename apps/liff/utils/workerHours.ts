...
//   ここは「LIFF 固有の表示」だけを持つ。
//   2026-08-16 まで admin と2本に分かれ、**同じ関数名で workedMin の意味が
//   違っていた**（liff=累積 / admin=その現場ぶん）。統合して admin 版を正とした。
//
//  ★getRateLines だけは共有しない。ラベルを i18n で出すため（admin は日本語直書き）。
//   ここを shared に入れると i18n を共有層に持ち込むことになる。
// ============================================================
