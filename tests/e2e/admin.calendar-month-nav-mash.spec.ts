// ============================================================
//  admin.calendar-month-nav-mash.spec.ts
//  予定管理の月送りボタン(‹/›)連打で、navMonthがonGridScroll(スクロール
//  イベント)頼みだと1ヶ月先で足踏みしていた不具合の回帰テスト（liffと同型修正）。
...
test('予定管理の月送り(›)を素早く3連打すると3ヶ月先まで正しく進む', async ({ page }) => {
